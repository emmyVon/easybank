      ...
      <nav>
        <div className='container nav-container'>
             <img src={logo} alt='logo'/>
              ...
              {showmenu? <img className='menu' src={close} alt='menu' onClick={()=>setShowMenu(false)}/> : <img className='menu' src={menu} alt='menu' onClick={()=>setShowMenu(true)}/>}    
        </div>  
      </nav>
      <header>
        <div className=' header-container'>
             <div className='header-left'>
                ...
                <p>Take your financial life online. Your Easybank account will be one step shop for spending. saving,budgeting,investing and more</p>
                <button>request</button>
              </div>
      ...
      <section className='service'>
        <div className='container services-container'>
            <div>
              ...
              <p>mauris sit amet massa vitae tortor condimentum lacinia quis vel eros donec ac odio tempor orci dapibus ultrices in iaculis</p>
            </div>
            <div className='services'>
              <div>
                <img src={online} alt='logo'/>
                  <h3>online Banking</h3>
                  <p>enim ut tellus elementum sagittis vitae et leo duis ut diam quam nulla porttitor massa id neque aliquam vestibulum morbi blandit cursus</p>
              </div>
              <div>
